# AMDS Daisy Chain Adapter Board <!-- omit from toc -->

**Archive the daisy chain adapter design files and documentation.**
...
Documentation about the design of this  board can be found in the [docs folder.](docs/)
